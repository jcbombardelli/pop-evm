		...
		+ BlockBuilderApi<Block, Error = sp_blockchain::Error>,
{
	...
	fn propose(
		...
		tokio_executor::blocking::run(move || {
			...
			println!("Log: Vendor>Substrate>Client>basic-authorship>src>basic_authorship.rs ---> Iniciando o propose");
		...
		+ BlockBuilderApi<Block, Error = sp_blockchain::Error>,
{
	fn propose_with(
		...
		for inherent in block_builder.create_inherents(inherent_data)? {
			println!("Log: Vendor>Substrate>Client>basic-authorship>src>basic_authorship.rs ---> inherent ");
		...
		println!("Log: Vendor>Substrate>Client>Cli>BASIC-AUTHOTSHIP>SrC>basic_authorship.rs ---> Iniciando o run_subcommand");
