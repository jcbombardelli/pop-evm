...
impl<C: SubstrateCli> Runner<C> {
	...
	//TODO: ALTERAR INFORMAÇÕES --> Vai ser definido com o MARCUS quais dados ele quer que seja exibido
	//LICENÇA INEPP
	//chain specification . Proof of participation
	//Native Runtime : POP-NODE
	//NOde name capivara-01
	fn print_node_infos(&self) {
		info!("{}", C::impl_name());
		info!("✌️  version - \"Capivara\":{}", C::impl_version());
		info!(
			"❤️  by {}, {}-{}",
			C::author(),
